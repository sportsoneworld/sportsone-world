...
url: "/terms/"
description: "The terms on which SportsOne makes this website available to readers."
build:
  list: never
---

These terms cover your use of the SportsOne website. By reading the site you
accept them.

## Using the site

SportsOne is free to read. You may link to any page, quote briefly from an
article with attribution, and share our stories on social platforms.

You may not republish an article in full, present our reporting as your own,
scrape the site at a rate that degrades it for other readers, or use our
material to train a model without a written agreement.

## Our journalism

Every story is written and edited by the SportsOne desk. Scores and fixtures
are compiled by the desk and published as a static page, which means they are
accurate as of the last update shown, not to the second.

We correct mistakes. If you believe something we have published is wrong,
[tell us](/contact/) and we will look at it.

## Copyright

The words, page designs and the SportsOne name and marks belong to SportsOne.
Photography may be licensed from third parties and is credited where required.

## Liability

The site is published in good faith and without warranty. We are not liable
for decisions taken on the basis of anything published here, including betting
decisions.
